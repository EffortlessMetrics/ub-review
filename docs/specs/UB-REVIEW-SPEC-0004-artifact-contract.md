...
| review/reply-candidates.json | conditional | github_review_reply_candidates.v1; exact current head and claim/comment ids | `ub-review post`; reviewer-action telemetry | required when direct replies are prepared |
