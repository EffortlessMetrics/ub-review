...
| 6 | `audit-ci` | 0007 | Which CI should stay required, become adaptive, or move? | v0 — deterministic judgment only; local permissions/secrets receipts implemented; branch-protection query not yet implemented |
