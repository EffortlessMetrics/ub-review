...
| 9 | Release binary / Action install | 0010 | How do I install this without rebuilding the world? | partial - v0.1.0 and v0.1.1 archives are published; source package 0.1.2 is uncut in the 2026-09-08 snapshot. Release-only portability, stable-tool and next-candidate acceptance remain #815/#816/#817; see SPEC-0010 and the release runbook |
