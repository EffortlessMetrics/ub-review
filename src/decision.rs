//! PR decision analysis: proof receipt classification, test-witness
//! question matching, diff structural analysis, stale-finding and noise
//! detection, and summary-finding ranking/dedupe (cleanup train step 23,
//! pure code motion).
