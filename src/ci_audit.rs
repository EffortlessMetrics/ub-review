//! CI audit and setup-ci subsystem: audit-ci read-only right-sizing
//! report plus setup-ci PR generation, including GitHub Actions YAML
//! scanning, job-tier classification, CI history fetch, and artifact
//! rendering (cleanup train step 60, pure code motion).
