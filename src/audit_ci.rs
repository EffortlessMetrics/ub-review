//! audit-ci: the read-only CI right-sizing report (cleanup train step 17,
//! pure code motion). Inventory, run history, costs, failure correlation,
//! and tiered recommendations with receipts - no writes outside
//! <out>/ci-audit/, no mutation anywhere.
