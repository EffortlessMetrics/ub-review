//! CI audit wizard: workflow inventory, duration/flake/independent-signal
//! measurement, and tier recommendations (cleanup train step 15, pure
//! code motion). Read-only and deterministic first: it scans local
//! workflow YAML, fetches run history via the GitHub API, classifies jobs
//! into tiers, and writes receipt-backed artifacts + a human report.
...
pub(crate) struct CiJobStats {
    ...
    pub(crate) cancelled_started_without_completion: usize,
    pub(crate) duration_p50_sec: Option<u64>,
    pub(crate) duration_p90_sec: Option<u64>,
    pub(crate) duration_p99_sec: Option<u64>,
    ...
    pub(crate) rerun_then_pass: usize,
}
...
pub(crate) struct CiCostsJob {
    ...
    pub(crate) duration_p90_sec: Option<u64>,
    pub(crate) duration_p99_sec: Option<u64>,
    pub(crate) runner_minutes_per_month: u64,
...
pub(crate) struct CiCorrelationArtifact {
    ...
    pub(crate) repo: String,
    pub(crate) window_days: u32,
    pub(crate) independent_failure_rule: String,
...
pub(crate) struct CiRunnerCancellation {
    ...
    pub(crate) runner_labels: Vec<String>,
