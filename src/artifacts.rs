...
pub(crate) const CALIBRATION_SCHEMA: &str = "ub-review.calibration.v0";
...
pub(crate) const COST_RECEIPT_SCHEMA: &str = "ub-review.cost_receipt.v1";
...
pub(crate) const QUALITY_BACKFILL_SCHEMA: &str = "ub-review.quality_backfill.v1";
pub(crate) const GITHUB_QUALITY_OUTCOMES_SCHEMA: &str = "ub-review.github_quality_outcomes.v1";
pub(crate) const QUALITY_TREND_SCHEMA: &str = "ub-review.quality_trend.v1";
...
pub(crate) const RIPR_EXPOSURE_GAPS_V3_SCHEMA: &str = "ub-review.ripr_exposure_gaps.v3";
...
pub(crate) const TASK_LEDGER_EVENT_SCHEMA: &str = "ub-review.task_ledger_event.v1";
pub(crate) const TASK_LEDGER_SNAPSHOT_SCHEMA: &str = "ub-review.task_ledger_snapshot.v1";
